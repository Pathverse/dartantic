...
class ASG {
  ...
  /// Creates a const constructor with no body (just a semicolon)
  static ASG CONST_CONSTRUCTOR({
    required String name,
    ...
    // Const constructors always end with a semicolon
    asg.addLine('$header;');
    return asg;
  }

  /// Creates a constructor with no body (just a semicolon)
  static ASG NO_BODY_CONSTRUCTOR({
    required String name,
    List<String> parameters = const [],
    List<String> initializers = const [],
    bool isConst = false,
    ...
    // No body constructors always end with a semicolon
    asg.addLine('$header;');
    return asg;
  }

  /// Creates a constructor with a body block
  ...
  static ASG CLASS({
    ...
    final implementsStr =
        implementsList?.isNotEmpty == true
            ...
            : '';
    final mixinsStr =
        mixinsList?.isNotEmpty == true ? ' with ${mixinsList!.join(', ')}' : '';
  ...
  static ASG SINGLETON({
    ...
    return ASG.CLASS(
      ...
      constructors: [
        // Private constructor
        ASG.NO_BODY_CONSTRUCTOR(name: '$name._internal', isPrivate: true),
        // Factory constructor
        ASG.CONSTRUCTOR(
          name: name,
          isFactory: true,
